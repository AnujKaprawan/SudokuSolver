...
public class Sudoku extends javax.swing.JFrame {
    ...
    int[][] board = new int[9][9]; // To store User's inputs and check at the end
    ...
    public void initialiseInputs() {
        ...
        // Initialise the number of inputs
    ...
    public boolean isValid(int i, int j, int num) {
        if(rows[i].contains(num)) return false; // If already present in row[i] then we no need to add again
    ...
    // Add the number in the particular cell
    ...
    // Selecting the number which we want between 1 to 9
